    ...
    <div class="container container_narrower">
      ...
      <div class="payment">
        <div class="payment__step" data-step="2">
          <form method="POST" action="/payments/start2pay/payment" class="form-horizontal">
            <div class="payment__amount">
              ...
              <div class="select js-select refill__select">
            ...
            <div class="button-wrapper"><button class="button_yellow button_arrow_right button_large payment__step__button button" type="submit">{{lang.start-paying.pay}}</button></div>
          </form>
        </div>
      </div>
    </div>
